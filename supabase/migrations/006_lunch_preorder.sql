...
insert into public.lunch_menu (course, position, label, note, tag) values
  ('starter', 1, 'Whipped Goats Cheese',
     'Honey & thyme beetroot, blackberries, orange, chicory & frisée, smoked almonds, sundried tomato focaccia', 'V'),
  ...
  ('main', 1, '6oz Sirloin Steak',
     'Pomme frites, pepper sauce (fillet +€10)', null),
  ('main', 2, 'Thai Veg Curry',
     'Roasted squash, onion, pepper, baby corn, mangetout, basmati rice & cashews', 'VG'),
  ('main', 3, 'Tandoori Chicken Supreme',
     'Tomato & white bean cassoulet, celeriac & fennel salad, balsamic emulsion', null),
  ('main', 4, 'Pan Fried Cod',
     'Tomato & white bean cassoulet, celeriac & fennel salad, balsamic emulsion', null),

  ('dessert', 1, 'Chocolate Fondant',
     'Ferrero Rocher ice cream', null),
  ('dessert', 2, 'Apple & Cinnamon Crumble',
     'Crème anglaise & vanilla ice cream', null),
  ('dessert', 3, 'Belgian Chocolate Cheesecake',
     'Non-dairy chocolate gelato', 'VG'),
  ('dessert', 4, 'Irish Cheese Selection',
