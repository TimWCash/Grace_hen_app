...
// Lightweight stand-in for next-themes — this app doesn't ship a theme switcher,
// but the component was authored against next-themes. Keeping the hook
// signature lets the component stay structurally identical to the upstream.
